		...
		<input type="hidden" name="viagem_id" value="{{ $viagem['id'] }}">
         ...
         <div class="form-group">
           ...
           <div class="form-group">
               ...
               <input type="datetime-local" class="form-control" id="viagem_saida" name="data_saida" value="{{$viagem['data_saida']}}">
               
             </div>
               <div class="form-group">
               <label for="viagem_retorno">Data Retorno</label>
               <input type="datetime-local" class="form-control" id="viagem_retorno" name="data_retorno" value="{{$viagem['data_retorno']}}">
